...
export const DEFAULT_CONFIG: OfferConfig = {
  ...
  content: {
    ...
    capabilities: {
      ...
      sub: "Web, software, 3D, AI visuals, ads, content and monitoring. Each of these is something I have built and shipped, not a line on a service sheet.",
      items: [
        ...
        { title: "AI Video Production", blurb: "Cinematic walkthroughs, reels and timelapses from an AI video pipeline. Sound, motion and grade, not slideshow exports.", proof: "End-to-end AI video pipeline in production" },
        ...
        { title: "Social Media Management", blurb: "Content calendars, scheduling, DM funnels and community work. ManyChat auto-reply and lead routing wired to the content plan.", proof: "ManyChat flows + content-plan system live on zZzlim" },
        { title: "Ad Management", blurb: "Paid-media setup and ongoing optimization: Meta, Google, TikTok. Campaign architecture, creative testing, monthly performance review.", proof: "Performance accounts run for own brands and clients" },
        { title: "Monitoring & Analytics", blurb: "Custom dashboards that pull your data into one view: site analytics, ad performance, pipeline, uptime. The same monitoring I build for myself.", proof: "AETHER monitoring + bespoke client dashboards" },
